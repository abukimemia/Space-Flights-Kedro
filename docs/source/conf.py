...
# space_flights_kedro documentation build
...
from space_flights_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "space_flights_kedro"
author = "Kedro"
...
htmlhelp_basename = "space_flights_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "space_flights_kedro.tex",
        "space_flights_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "space_flights_kedro",
        "Project space_flights_kedro codebase.",
        "Data-Science",
    )
]
